...
<body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <button type="button" class="btn btn-success m-b-sm" data-toggle="modal" data-target="#addModal">Add New Program</button>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= esc($program['program_status']); ?></td>
                                                <td>
                                                    <button class="btn btn-primary" data-toggle="modal" data-target="#editModal<?= $program['program_id']; ?>">Edit</button>
                                                    <button class="btn btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="<?= $program['program_id']; ?>">Delete</button>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
    ...
    <!-- Modal Add -->
    <form action="<?= base_url('admin/programs/add'); ?>" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <input type="text" name="program_title" class="form-control" placeholder="Program Title" required>
                        </div>
                        <div class="form-group">
    ...
    <?php foreach ($programs as $program) : ?>
        <!-- Modal Edit -->
        <form action="<?= base_url('admin/programs/edit/' . $program['program_id']); ?>" method="POST">
            <div class="modal fade" id="editModal<?= $program['program_id']; ?>" tabindex="-1" role="dialog">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input type="text" name="program_title" value="<?= esc($program['program_title']); ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <input type="date" name="program_date" value="<?= esc($program['program_date']); ?>" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <select name="category_id" class="form-control" required>
                                    <?php foreach ($categories as $row) : ?>
                                        <option value="<?= $row['id']; ?>" <?= $program['category_id'] == $row['id'] ? 'selected' : ''; ?>><?= $row['name']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    <!-- Modal Delete -->
    <form action="<?= base_url('admin/programs/delete'); ?>" method="POST">
