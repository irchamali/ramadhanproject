...
<head>
<meta charset="utf-8">
<title>POROZ - <?= $site['site_name']; ?></title>
					...
					<div class="d-flex justify-content-between align-items-center flex-wrap">
						<div class="left-box d-flex align-items-center flex-wrap">
							...
							<ul class="header-top_list">
								...
								<li><span class="icon fa-solid fa-location-dot fa-fw"></span>Perkumpulan Organisasi Pengelola Zakat</li>
							</ul>
							<!-- <div>Gunung Jati</div> -->
			...
			<div class="auto-container">
				<div class="inner-container">
					<div class="d-flex justify-content-between align-items-center flex-wrap">
						...
						<div class="logo-box">
							<!-- <div class="logo"><a href="/"><img src="<?= base_url(''); ?>assets/quran/images/poroz-logo.png" alt="Logo_header" title=""></a></div> -->
							<div class="logo"><a href="/"><img src="<?= base_url(''); ?>assets/backend/images/site/<?= $site['site_logo_header']; ?>" alt="Logo_header" title=""></a></div>
						</div>
