...
<meta content="<?= $program['program_desc'] ?? $site['site_description']; ?>" name="description">
<!-- SEO Tag -->
<meta property="og:type" content="website" />
<meta property="og:image:type" content="image/jpeg">
<meta property="og:image" content="<?= base_url('/assets/backend/images/programs/') . $program['program_image']; ?>">
<meta property="og:image:secure_url" content="<?= base_url('/assets/backend/images/programs/') . $program['program_image']; ?>" />
