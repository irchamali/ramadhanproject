    ...
    <div class="container">
        ...
        <form id="zakat-maal" class="tab-content active">
            ...
            <div class="form-group">
                ...
                <input type="number" id="g" placeholder="" required>
            </div>
            <div class="form-group">
        ...
        <form id="zakat-profesi" class="tab-content">
            <div class="form-group">
                ...
                <input type="number" id="penghasilan-profesi" placeholder="Masukkan penghasilan bulanan" required>
            </div>
            <div class="form-group">
                <label for="kebutuhan-profesi">Kebutuhan Pokok dalam 1 bulan:</label>
                <input type="number" id="kebutuhan-profesi" placeholder="Masukkan kebutuhan pokok" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" id="hargaemas-profesi" placeholder="Masukkan Harga Emas saat ini" required>
            </div>
            <div class="form-group">
